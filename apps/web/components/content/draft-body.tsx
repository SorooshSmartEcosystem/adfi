...
// reel/story frames. Falls back to a neutral placeholder while the image
// is still being generated by Replicate (echo backfills these in the
// background — see backfillImagesForDraft in agents/echo.ts).
function HeroImage({
  url,
  aspect = "1/1",
}: {
  ...
  if (!url) {
    return (
      <div
        className="w-full bg-bg border-hairline border-border rounded-md flex items-center justify-center mb-md"
  ...
  return (
    ...
    <img
      src={url}
      alt=""
      className="w-full rounded-md mb-md object-cover"
      style={{ aspectRatio: aspect }}
    />
  );
}
