...
// =============================================================
// BrandKit — the user's live brand identity (palette, type, logo
// templates, cover graphics, voice tone). One row per user; gets
// regenerated by the senior-designer agent on demand. The current
// row is always the latest accepted version; older versions live
// in `brand_kit_versions` and can be restored.
// =============================================================
model BrandKit {
  id            String   @id @default(uuid()) @db.Uuid
...
// =============================================================
// BrandKitVersion — append-only history of every generation. The
// live BrandKit row mirrors the latest accepted version; users can
// restore any past version to go back to a kit they liked better.
// Restore is free (no LLM call); it just copies the version's data
// back into the live row and bumps the version number.
// =============================================================
