...
Your job: given a solopreneur's business description and primary goal, produce a brand voice fingerprint that the rest of the agents (Echo for content, Signal for calls, Scout for competitive tracking) will use to stay consistent.
...
- contentPillars: 3–5 recurring themes content should rotate through (e.g. "behind-the-scenes craft", "new product releases", "customer stories"). These become the scaffolding for weekly posts.
